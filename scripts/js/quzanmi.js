 ...
 *
 * 环境变量:
 *   QUZANMI_COOKIE: 去赞米Cookie，多个账号用 &、\n 或 @ 分隔
 *
 * 参考文档: https://www.quzanmi.com/
 */

const { Env } = require('../../utils');

const $ = new Env('去赞米签到', { sep: ['@', '\n', '&'] });
...
class Quzanmi {
  ...
  async signIn() {
    try {
      const response = await $.req.get('https://www.quzanmi.com/api/user/sign', {
        headers: {
          'Cookie': this.cookie,
