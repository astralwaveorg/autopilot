 ...
 *
 * 环境变量:
 *   HQCSH_COOKIE: 华清生活Cookie，多个账号用 &、\n 或 @ 分隔
 *
 * 参考文档: https://www.hqcsh.com/
 */

const { Env } = require('../../utils');

const $ = new Env('华清生活签到', { sep: ['@', '\n', '&'] });
...
class Hqcsh {
  ...
  async signIn() {
    try {
      const response = await $.req.get('https://www.hqcsh.com/api/user/sign', {
        headers: {
          'Cookie': this.cookie,
