 ...
 *
 * 环境变量:
 *   GQFTBZ_COOKIE: 共青体Cookie，多个账号用 &、\n 或 @ 分隔
 *
 * 参考文档: https://www.gqftbz.com/
 */

const { Env } = require('../../utils');

const $ = new Env('共青体签到', { sep: ['@', '\n', '&'] });
...
class Gqftbz {
  ...
  async signIn() {
    try {
      const response = await $.req.get('https://www.gqftbz.com/api/user/sign', {
        headers: {
          'Cookie': this.cookie,
