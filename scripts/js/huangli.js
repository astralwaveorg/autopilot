 ...
 *
 * 环境变量:
 *   HUANGLI_COOKIE: 黄历Cookie，多个账号用 &、\n 或 @ 分隔
 *
 * 参考文档: https://www.huangli.com/
 */

const { Env } = require('../../utils');

const $ = new Env('黄历签到', { sep: ['@', '\n', '&'] });
...
class Huangli {
  ...
  async signIn() {
    try {
      const response = await $.req.get('https://www.huangli.com/api/user/sign', {
        headers: {
          'Cookie': this.cookie,
