 ...
 *
 * 环境变量:
 *   JLZX_COOKIE: 金龙智选Cookie，多个账号用 &、\n 或 @ 分隔
 *
 * 参考文档: https://www.jlzx.com/
 */

const { Env } = require('../../utils');

const $ = new Env('金龙智选签到', { sep: ['@', '\n', '&'] });
...
class Jlzx {
  ...
  async signIn() {
    try {
      const response = await $.req.get('https://www.jlzx.com/api/user/sign', {
        headers: {
          'Cookie': this.cookie,
