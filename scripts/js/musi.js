 ...
 *
 * 环境变量:
 *   MUSI_COOKIE: 慕思Cookie，多个账号用 &、\n 或 @ 分隔
 *
 * 参考文档: https://www.musi.com/
 */

const { Env } = require('../../utils');

const $ = new Env('慕思签到', { sep: ['@', '\n', '&'] });
...
class Musi {
  ...
  async signIn() {
    try {
      const response = await $.req.get('https://www.musi.com/api/user/sign', {
        headers: {
          'Cookie': this.cookie,
