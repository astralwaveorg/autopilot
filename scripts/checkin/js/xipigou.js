 ...
 * @Author: Astral
 * @Date: 2025-01-28
 * @Description: xipigou.js - checkin
 * @Source: AutoPilot
 *
 * 
 *
...
/*
app  api.cpgoshop.com Authorization
export XPG='#1,ios2#token'
   1
*/
...
! function(t) {
        ...
        o = new function(e, n) {
            return new class {
                ...
                msg(t = e, n = "", c = "", r) {
                    ...
                    o.isMute || (this.isSurge() || this.isLoon() ? $notification.post(t, n, c, s(r)) : this.isQuanX() && $notify(t, n, c, s(r))), this.logs.push("", "============================"), this.logs.push(t), n && this.logs.push(n), c && this.logs.push(c)
                }
                log(...t) {
                    t.length > 0 ? this.logs = [...this.logs, ...t] : console.log(this.logs.join(this.logSeparator))
                }
                logErr(t, e) {
                    !this.isSurge() && !this.isQuanX() && !this.isLoon() ? o.log("", `${this.name}, !`, t.stack) : o.log("", `${this.name}, !`, t)
                }
                wait(t) {
                    ...
                    this.log("", `${this.name}, !  ${e} `), this.log(), (this.isSurge() || this.isQuanX() || this.isLoon()) && $done(t)
                }
            }(e, n)
        },
        n = 15e3;
    ...
    function U(t, e) {
        return new Promise((n => {
            if (c && r) {
                ...
                o.post(W, ((t, e, c) => {
                    try {
                        t ? (console.log("gotifyAPI\n"), console.log(t)) : (c = JSON.parse(c)).id ? console.log("gotify\n") : console.log(`${c.message}\n`)
                    } catch (t) {
                        o.logErr(t, e)
                    } finally {
                        n()
    ...
    function A(t, e) {
        return new Promise((c => {
            if (W) {
                ...
                o.post(r, ((t, e, n) => {
                    try {
                        t ? (console.log("go-cqhttpAPI\n"), console.log(t)) : 0 === (n = JSON.parse(n)).retcode ? console.log("go-cqhttp\n") : 100 === n.retcode ? console.log(`go-cqhttp: ${n.errmsg}\n`) : console.log(`go-cqhttp\n${JSON.stringify(n)}`)
                    } catch (t) {
                        o.logErr(t, e)
                    } finally {
                        c(n)
    ...
    function E(t, e) {
        return new Promise((c => {
            if (u) {
                ...
                o.post(r, ((t, e, n) => {
                    try {
                        t ? (console.log("API\n"), console.log(t)) : 0 === (n = JSON.parse(n)).errno || 0 === n.data.errno ? console.log("server\n") : 1024 === n.errno ? console.log(`server: ${n.errmsg}\n`) : console.log(`server\n${JSON.stringify(n)}`)
                    } catch (t) {
                        o.logErr(t, e)
                    } finally {
                        c(n)
    ...
    function Z(t, e) {
        return new Promise((c => {
            if (d) {
                ...
                o.post(r, ((t, e, n) => {
                    try {
                        t ? (console.log("API\n"), console.log(t)) : void 0 !== (n = JSON.parse(n)).content.result.length && n.content.result.length > 0 ? console.log("PushDeer\n") : console.log(`PushDeer\n${JSON.stringify(n)}`)
                    } catch (t) {
                        o.logErr(t, e)
                    } finally {
                        c(n)
    ...
    function Y(t, e) {
        return new Promise((n => {
            if (f && l) {
                ...
                o.post(c, ((t, e, c) => {
                    try {
                        t ? (console.log("API\n"), console.log(t)) : (c = JSON.parse(c)).success ? console.log("Chat\n") : console.log(`Chat\n${JSON.stringify(c)}`)
                    } catch (t) {
                        o.logErr(t)
                    } finally {
                        n(c)
    ...
    function D(t, c, r = {}) {
        return new Promise((s => {
            if (x) {
                ...
                o.get(W, ((t, e, n) => {
                    try {
                        t ? (console.log("Bark APPAPI\n"), console.log(t)) : 200 === (n = JSON.parse(n)).code ? console.log("Bark APP\n") : console.log(`${n.message}\n`)
                    } catch (t) {
                        o.logErr(t, e)
                    } finally {
                        s()
    ...
    function F(t, e) {
        return new Promise((c => {
            if (_ && b) {
                ...
                o.post(r, ((t, e, n) => {
                    try {
                        t ? (console.log("telegram\n"), console.log(t)) : (n = JSON.parse(n)).ok ? console.log("Telegram\n") : 400 === n.error_code ? console.log("botID\n") : 401 === n.error_code && console.log("Telegram bot token \n")
                    } catch (t) {
                        o.logErr(t, e)
                    } finally {
                        c(n)
        ...
        return new Promise((c => {
            ...
            if (Q && w) {
                ...
                r.url = `${r.url}&timestamp=${e}&sign=${s}`, o.post(r, ((t, e, n) => {
                    try {
                        t ? (console.log("\n"), console.log(t)) : 0 === (n = JSON.parse(n)).errcode ? console.log("\n") : console.log(`${n.errmsg}\n`)
                    } catch (t) {
                        o.logErr(t, e)
                    } finally {
                        c(n)
    ...
    function ot(t, c, r = {}) {
        return new Promise((s => {
            if (q) {
                if (!new RegExp("^[a-zA-Z0-9]{24}$").test(q)) return console.log("IGOT_PUSH_KEY\n"), void s();
                const W = {
                ...
                o.post(W, ((t, e, n) => {
                    try {
                        t ? (console.log("API\n"), console.log(t)) : ("string" == typeof n && (n = JSON.parse(n)), 0 === n.ret ? console.log("iGot\n") : console.log(`iGot${n.errMsg}\n`))
                    } catch (t) {
                        o.logErr(t, e)
                    } finally {
                        s(n)
    ...
    function nt(t, e) {
        return new Promise((c => {
            if (K) {
                ...
                o.post(s, ((t, e, n) => {
                    try {
                        t ? (console.log(`push+${I?"":""}\n`), console.log(t)) : 200 === (n = JSON.parse(n)).code ? console.log(`push+${I?"":""}\n`) : console.log(`push+${I?"":""}${n.msg}\n`)
                    } catch (t) {
                        o.logErr(t, e)
                    } finally {
                        c(n)
    ...
    function ct(t, e) {
        return new Promise((c => {
            if (J && N && j) {
                ...
                o.post(W, ((t, e, n) => {
                    try {
                        t ? (console.log("\n"), console.log(t)) : 0 === (n = JSON.parse(n)).code ? console.log("\n") : console.log(`${n.error}\n`)
                    } catch (t) {
                        o.logErr(t, e)
                    } finally {
                        c(n)
    ...
    function rt(t, e) {
        return new Promise((c => {
            if (L) {
                ...
                o.post(r, ((t, e, n) => {
                    try {
                        t ? (console.log("API\n"), console.log(t)) : 0 === (n = JSON.parse(n)).StatusCode ? console.log("\n") : console.log(`${n.msg}\n`)
                    } catch (t) {
                        o.logErr(t, e)
                    } finally {
                        c(n)
    ...
    async function st(t, e) {
        if ([T, B, M].every(Boolean)) try {
            ...
            if ((await o.sendMail({
                    ...
                    subject: t,
                    text: e
                })).messageId) return console.log("SMTP\n"), !0;
            console.log("SMTP\n")
        } catch (t) {
            console.log("SMTP\n"), console.log(t)
        }
    ...
    function Wt(t, e, c = {}) {
        return new Promise((r => {
            if (z) {
                ...
                o.post(s, ((t, e, n) => {
                    try {
                        t ? (console.log("PushMeNotifyAPI\n"), console.log(t)) : "success" === n ? console.log("PushMe\n") : console.log(`${n}\n`)
                    } catch (t) {
                        o.logErr(t, e)
                    } finally {
                        r(n)
    ...
    process.env.GOTIFY_URL && (c = process.env.GOTIFY_URL), process.env.GOTIFY_TOKEN && (r = process.env.GOTIFY_TOKEN), process.env.GOTIFY_PRIORITY && (s = process.env.GOTIFY_PRIORITY), process.env.GOBOT_URL && (W = process.env.GOBOT_URL), process.env.GOBOT_TOKEN && (i = process.env.GOBOT_TOKEN), process.env.GOBOT_QQ && (a = process.env.GOBOT_QQ), process.env.PUSH_KEY && (u = process.env.PUSH_KEY), process.env.DEER_KEY && (d = process.env.DEER_KEY, h = process.env.DEER_URL), process.env.CHAT_URL && (f = process.env.CHAT_URL), process.env.CHAT_TOKEN && (l = process.env.CHAT_TOKEN), process.env.QQ_SKEY && process.env.QQ_SKEY, process.env.QQ_MODE && process.env.QQ_MODE, process.env.BARK_PUSH ? (x = process.env.BARK_PUSH.indexOf("https") > -1 || process.env.BARK_PUSH.indexOf("http") > -1 ? process.env.BARK_PUSH : `https://api.day.app/${process.env.BARK_PUSH}`, process.env.BARK_ICON && (k = process.env.BARK_ICON), process.env.BARK_SOUND && (p = process.env.BARK_SOUND), process.env.BARK_GROUP && (m = process.env.BARK_GROUP), process.env.BARK_LEVEL && (S = process.env.BARK_LEVEL), process.env.BARK_URL && (C = process.env.BARK_URL)) : x && -1 === x.indexOf("https") && -1 === x.indexOf("http") && (x = `https://api.day.app/${x}`), process.env.TG_BOT_TOKEN && (_ = process.env.TG_BOT_TOKEN), process.env.TG_USER_ID && (b = process.env.TG_USER_ID), process.env.TG_PROXY_AUTH && (P = process.env.TG_PROXY_AUTH), process.env.TG_PROXY_HOST && (O = process.env.TG_PROXY_HOST), process.env.TG_PROXY_PORT && (g = process.env.TG_PROXY_PORT), process.env.TG_API_HOST && (R = process.env.TG_API_HOST), process.env.DD_BOT_TOKEN && (Q = process.env.DD_BOT_TOKEN, process.env.DD_BOT_SECRET && (w = process.env.DD_BOT_SECRET)), v = process.env.QYWX_ORIGIN ? process.env.QYWX_ORIGIN : "https://qyapi.weixin.qq.com", process.env.QYWX_KEY && (y = process.env.QYWX_KEY), process.env.QYWX_AM && (G = process.env.QYWX_AM), process.env.IGOT_PUSH_KEY && (q = process.env.IGOT_PUSH_KEY), process.env.PUSH_PLUS_TOKEN && (K = process.env.PUSH_PLUS_TOKEN), process.env.PUSH_PLUS_USER && (I = process.env.PUSH_PLUS_USER), process.env.AIBOTK_KEY && (J = process.env.AIBOTK_KEY), process.env.AIBOTK_TYPE && (N = process.env.AIBOTK_TYPE), process.env.AIBOTK_NAME && (j = process.env.AIBOTK_NAME), process.env.FSKEY && (L = process.env.FSKEY), process.env.SMTP_SERVER && (T = process.env.SMTP_SERVER), process.env.SMTP_SSL && (H = process.env.SMTP_SSL), process.env.SMTP_EMAIL && (B = process.env.SMTP_EMAIL), process.env.SMTP_PASSWORD && (M = process.env.SMTP_PASSWORD), process.env.SMTP_NAME && (V = process.env.SMTP_NAME), process.env.PUSHME_KEY && (z = process.env.PUSHME_KEY), t.exports = {
        sendNotify: async function(t, e, o = {}, n = "\n\n ") {
            ...
            c && c.split("\n").includes(t) ? console.info(t + "SKIP_PUSH_TITLE") : (await Promise.all([E(t, e), nt(t, e)]), t = t.match(/.*?(?=\s?-)/g) ? t.match(/.*?(?=\s?-)/g)[0] : t, await Promise.all([D(t, e, o), F(t, e), X(t, e), $(t, e), et(t, e), ot(t, e, o), A(t, e), U(t, e), Y(t, e), Z(t, e), ct(t, e), rt(t, e), st(t, e), Wt(t, e, o)]))
        },
        BARK_PUSH: x
    }
}(sendNotify);
...
class _0x1f4295 {
    [_0x2ece92(579, "ZPVG")](t) {
        ...
        (t || o[e(622, "Sx8y")](t, 0)) && (this[e(500, "s9TC")] = o[e(617, "XPr&")](t, 1), this[e(635, "R6IL")] = "" + this[e(638, "H&(W")] + " ", this[e(563, "&)@m")] = ""), this[e(566, "#4aH")] = !0, this[e(624, "4y4J") + e(498, "]K&p")] = !1
    } [_0x2ece92(567, "H&(W")](t) {
        this.ck = t
    } [_0x2ece92(484, "j7Tb")]() {
...
async function _0x3894e2(t, e) {
    ...
    return console[o(575, "xOl[")]("" + W + o(615, "XPr&")), c
}! function(t, e) {
    const o = _0x2e40,
        n = _0x70e2();
    for (;;) try {
...
class _0x17ac26 extends _0x1f4295 {
    ...
    async [_0xb63371(806, "bAQS")](t, e) {
        ...
        0 === c.code ? this.log(o(897, "bAQS") + num + " , " + c[o(948, "*c9q")] + o(631, "51xm") + {
            hxntg: function(t, e) {
                return t / e
            }
        } [o(852, "Kw%J")](num, 10) + " ") : this.log(c.message)
    }
            ...
            for (let o of n)
                    ...
                    for (let o of n)
                        if (e.ZHLKu(o[t(673, "evvj")], e[t(604, "evvj")])) {
                            ...
                            for (let c = 0; e.jwMQX(c, n); c++) {
                                ...
                                await this[t(940, "O]8R") + "o"](n, "", e[t(938, "hj2z")](c, 1)), await this[t(1032, "^o8b") + t(892, "#q@H")](e[t(878, "Kw%J")])
                            }
                ...
                for (let o of n)
                    if (o[t(1064, "(s]m")] == e[t(1008, "Uoev")]) {
                        ...
                        if (e[t(562, "*c9q")](n, 8) && (n = 4, this[t(888, "(s]m")](o[t(817, "hj2z")][t(615, "O]8R")] + (t(1073, "hj2z") + "4"))), n > 0) {
                            let c = 5;
                            for (let r = 0; e.VLnBf(r, n); r++)
                                for (let n = 0; e.jwMQX(n, c); n++)
                                    if (this[t(904, "LmYO")](t(665, "M6[V") + e[t(692, "lPTc")](e[t(449, "M6[V")](o[t(610, ")zh[")], r), 1) + t(1123, "M6[V") + e[t(882, "(s]m")](n, 1) + " / " + c), await this.read_article(o[t(922, "OQn7")], t(912, "kpJL"), e[t(663, "YQwY")](n, 1)), 8 == e[t(626, "(s]m")](e[t(929, "bjv2")](o.user, r), 1) && e[t(567, "hj2z")](n, 1) == c && this[t(1161, "lPTc")](t(959, "jz(4") + t(1137, "$&]Z")), e[t(1180, "bjv2")](n, 1)) {
                                        ...
                                        if (e.DgcFw(o, 0)) {
                                            this[t(860, "#G9b")](t(530, "s!#d") + o + " "), await time.wait(o);
                                            break
                                        }
                                    }
                        }
                    ...
                    if (e[t(858, "Qh!K")](o[t(546, "ZBt0")][t(982, "OQn7")], 4) && o[t(921, "lPTc")][t(569, "euxu")] > 0)
                        for (; e[t(465, "^o8b")](o.data[t(659, "#G9b")], 0);) {
                            ...
                            this.log(": " + o + " ,  " + n?.[t(1082, "OQn7")]?.[t(1155, "50wA")] + " ");
    ...
    async [_0xb63371(1151, "#G9b") + "info"]() {
        ...
        if (e.ZRIve(o[t(1080, "zC%%")], 0)) {
            if (e[t(875, "PObQ")](o[t(546, "ZBt0")][t(477, "(UQm")], 0))
                for (let o = 0; e[t(1029, "kpJL")](o, 5); o++) this[t(679, "kpJL")](": " + e[t(582, "Uoev")](o, 1) + "/5"), await this[t(696, "jj$0") + "le"](e.KrXdt, "")
    ...
    async user_info() {
        ...
        } [t(433, "zC%%")](e[t(597, "YQwY")], 0) ? (console.log(e), this[t(707, "50wA")]()) : (this[t(660, "jz(4")](t(556, "zC%%") + e[t(921, "lPTc")][t(761, "$&]Z")] + t(1069, "Kw%J") + e[t(500, "bjv2")][t(1070, "(UQm")] + ", : " + e.data[t(1e3, "*c9q")] + ", : " + e[t(991, "^o8b")][t(1140, "M6[V")] + ", : " + e[t(844, "LmYO")][t(1040, "evvj") + t(1017, "PObQ")]), this[t(1066, "51xm")] = e[t(818, "Zm2J")][t(650, ")zh[")])
    }
    async [_0xb63371(589, "50wA")]() {
        ...
        if (e.HpqtN(o.code, 0)) {
            if (this.log(t(777, "^dth") + o[t(441, "iunc")][t(909, ")zh[")] + t(918, "lPTc") + o[t(552, "51xm")].seedling + t(924, "W)1Y") + o[t(1095, "uwds")][t(755, "ru27")][t(630, "50wA")] + " " + o[t(1110, "Qh!K")][t(471, "LmYO")][t(693, "Zm2J")] + ", -" + o[t(552, "51xm")].manure[t(1028, "(s]m")] + " " + o[t(1164, "[HJy")][t(978, "jz(4")][t(1086, "ix8P")] + t(757, "OQn7") + o[t(664, "xJx1")].status + t(1025, "lPTc") + o[t(801, "jj$0")].level), e[t(990, "ZBt0")](o[t(1189, "Xpu*")][t(1181, "hj2z")], 1)) {
                if (e.btiXp(o.data[t(881, "OQn7")], 0) && await this[t(774, "Xpu*")](t(957, "evvj"), e[t(1071, "kpJL")]), e[t(502, "*c9q")](o[t(1038, "hLuo")].water[t(745, "(UQm")], 7) && "" == o[t(480, "vP5I")][t(612, "W)1Y")][t(1154, "]%0B")] && (await this[t(916, "hLuo")](e[t(812, "]%0B")], ""), await this[t(1007, "OEpb")](this.help, 6, e[t(962, "(s]m")])), o[t(814, "W)1Y")][t(765, "jj$0")].amount >= 1 && "" == o[t(500, "bjv2")][t(765, "jj$0")][t(543, "O]8R")]) {
                    let o = time[t(1186, "(s]m")]();
                    e[t(736, "Qh!K")](o, 7) && await this[t(1142, "LmYO")](e[t(654, "(s]m")], "")
                }
            } else(e[t(804, "Uoev")](o.data.status, 2) || e[t(607, "ix8P")](o.data[t(747, "W)1Y")], 3)) && e[t(928, "hLuo")](o.data[t(960, "evvj")][t(1159, "M6[V")], 0) && (await this.melon_task(t(487, "uwds"), ""), await time.wait(random[t(540, "iU(Q")](30, 50)), await this[t(889, "50wA")](e[t(856, "OEpb")], ""));
    ...
    async [_0xb63371(953, "Kw%J")]() {
        ...
        } [t(584, "PObQ")](e.code, 0) ? this.log(e[t(932, "^o8b")]): (this[t(886, "^dth")](t(857, "gzOS") + e[t(838, "50wA")][t(453, "ZBt0")]), e.data[t(598, "OQn7")] > 10 && (this[t(653, "OEpb")](t(1173, "kpJL") + e[t(919, "#q@H")][t(512, "jj$0")] + " "), await this[t(874, "PObQ")](e.data[t(1058, "Xpu*")])))
    }
    async [_0xb63371(647, "[HJy")](t) {
        ...
        o[e(655, "Zm2J")](c[e(646, "PObQ")], 0) ? this.log(" " + t + e(575, "uwds") + c.message + e(950, "jz(4") + o[e(1133, "bjv2")](t, 10) + " ") : this.log(c[e(463, "QTN!")])
    }
    ...
    async [_0xb63371(560, "ZBt0")]() {
        ...
        if (e[t(1118, "kpJL")](o.code, 0)) {
            ...
            for (let o of n) {
                ...
                } else this[t(1147, "O]8R")](o[t(815, "YQwY")] + " -- ")
            }
