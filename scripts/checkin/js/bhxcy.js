...
[task_local]
#
44 7,18 * * * https://raw.githubusercontent.com/leafTheFish/DeathNote/main/bhxcy.js, tag=, enabled=true
[rewrite_local]
...
class _0x4ea0f5 {
  ...
  async taskApi(_0x46df8a = {}) {
    ...
    try {
      ...
      _0x1e3dc5.statusCode != 200 && console.log("[" + _0x46df8a.fn + "][" + _0x1e3dc5.statusCode + "]");
  ...
  async getUserInfo() {
    ...
    try {
      ...
      if (_0x17442d?.["result"] == 1) {
        ...
        _0x1d0ae3.logAndNotify("[" + this.index + "]: " + _0x17442d?.["msg"]);
      }
    } catch (_0x454ba2) {
  ...
  async getNotifyInfo() {
    ...
    try {
      ...
      _0x5ab653?.["result"] == 1 ? (this.point = _0x5ab653.PhoneBill, _0x1d0ae3.logAndNotify("[" + this.index + "][" + this.name + "]: " + this.point + "")) : _0x1d0ae3.logAndNotify("[" + this.index + "][" + this.name + "]: " + _0x5ab653?.["msg"]);
    } catch (_0x37aecc) {
  ...
  async SignIn() {
    ...
    try {
      ...
      _0x132263?.["result"] == 1 ? console.log(": " + _0x132263.msg) : console.log(": " + _0x132263?.["msg"]);
    } catch (_0x22e7fa) {
  ...
  async Recharge() {
    ...
    try {
      ...
      _0x3c4bab?.["result"] == 1 ? _0x1d0ae3.logAndNotify("[" + this.name + "]E: " + _0x3c4bab.msg) : _0x1d0ae3.logAndNotify("[" + this.name + "]E: " + _0x3c4bab?.["msg"]);
    } catch (_0x3c981d) {
  ...
  if ($request.url.includes("getUserInfo")) {
    try {
        ...
        if (_0x7a80f1?.["includes"](_0x4bf3e4)) {
          ...
          for (let _0x171e08 in _0x918533) {
            ...
            if (_0x918533[_0x171e08]?.["includes"](_0x4bf3e4)) {
              ...
              _0x1d0ae3.msg("" + (Number(_0x171e08) + 1) + "CK[" + _0x3f4443 + "]: " + _0x4150d4);
              _0x55a9ef = true;
              break;
            }
          }
      ...
      if (!_0x55a9ef) {
        ...
        _0x1d0ae3.msg("" + _0x32104d.length + "CK[" + _0x25bd00 + "]: " + _0x4150d4);
      }
    } catch (_0x3a170a) {
...
function _0x2e8fd7() {
  ...
  if (!_0x33bf72) {
    console.log("CK" + _0x217681.join(""));
    return false;
  }
  console.log("" + _0x33bf72 + "");
  return true;
}
async function _0x524745(_0x216eeb = 0) {
  ...
  try {
    ...
    if (_0x2ddd29.err) {
      console.log("[" + _0x2ddd29?.["resp"]?.["statusCode"] + "]...");
    } else {
      try {
    ...
    if (!_0x2eda60) {
      ...
      if (_0x2eda60[_0x4b2aa5]) {
        ...
        _0x574c4a.status == 0 ? _0x5e3f67 >= _0x574c4a.version ? (_0x4c3164 = true, console.log(_0x574c4a.msg[_0x574c4a.status]), console.log(_0x574c4a.updateMsg), console.log("" + _0x5e3f67 + "" + _0x574c4a.latestVersion)) : console.log(_0x574c4a.versionMsg) : console.log(_0x574c4a.msg[_0x574c4a.status]);
      } else {
