 ...
 *
 * 环境变量:
 *   GJZP_COOKIE: 国际招聘Cookie，多个账号用 &、\n 或 @ 分隔
 *
 * 参考文档: https://www.gjzp.com/
 */

const { Env } = require('../../utils');

const $ = new Env('国际招聘签到', { sep: ['@', '\n', '&'] });
...
class Gjzp {
  ...
  async signIn() {
    try {
      const response = await $.req.get('https://www.gjzp.com/api/user/sign', {
        headers: {
          'Cookie': this.cookie,
