 ...
 *
 * 环境变量:
 *   FTEJ_COOKIE: 飞特Cookie，多个账号用 &、\n 或 @ 分隔
 *
 * 参考文档: https://www.ftej.com/
 */

const { Env } = require('../../utils');

const $ = new Env('飞特签到', { sep: ['@', '\n', '&'] });
...
class Ftej {
  ...
  async signIn() {
    try {
      const response = await $.req.get('https://www.ftej.com/api/user/sign', {
        headers: {
          'Cookie': this.cookie,
