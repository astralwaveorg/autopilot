 ...
 *
 * 环境变量:
 *   YINXIANG_COOKIE: 印象Cookie，多个账号用 &、\n 或 @ 分隔
 *
 * 参考文档: https://www.yinxiang.com/
 */

const { Env } = require('../../utils');

const $ = new Env('印象签到', { sep: ['@', '\n', '&'] });
...
class Yinxiang {
  ...
  async signIn() {
    try {
      const response = await $.req.get('https://www.yinxiang.com/api/user/sign', {
        headers: {
          'Cookie': this.cookie,
