 ...
 *
 * 环境变量:
 *   CHAOXINWEN_COOKIE: 潮新闻Cookie，多个账号用 &、\n 或 @ 分隔
 *
 * 参考文档: https://www.chaoxinwen.com/
 */

const { Env } = require('../../utils');

const $ = new Env('潮新闻签到', { sep: ['@', '\n', '&'] });
...
class Chaoxinwen {
  ...
  async signIn() {
    try {
      const response = await $.req.get('https://www.chaoxinwen.com/api/user/sign', {
        headers: {
          'Cookie': this.cookie,
...
$.init(Chaoxinwen, 'CHAOXINWEN_COOKIE')
  .catch(error => {
