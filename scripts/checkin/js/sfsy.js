...
const _0x144bb1 = ["7", "", "", "", "", "DAILY_VIP_TASK_TYPE", "", "", "", "", "ID"];
let _0x11aa2a = [];
let _0x479306 = {};
let _0x48776e = 0;
let _0x3ecd02 = 0;
...
class _0x5d22ab {
    ...
    log(_0x3cad5d, _0x4f6fa8 = {}) {
        ...
        if (this.index) {
            _0x391c91 += "[" + _0x1366a8.padStr(this.index, _0x162cfd) + "]";
        }
        if (this.name) {
            _0x391c91 += "[" + this.name + "]";
        }
    ...
    async request(_0x2d52f2) {
        ...
        while (_0x233cd0 < _0x238e48) {
            try {
                ...
                if (_0x593f3a) {
                    this.log("[" + _0x50b2fa + "](" + _0x15f760 / 1000 + ")" + _0x233cd0 + "");
                } else {
                    if (_0x2963bf.includes(_0x4ab8a0)) {
                        this.log("[" + _0x50b2fa + "][" + _0x4ab8a0 + "][" + _0x16f16b + "]");
                        ...
                        if (_0x5aa27d.includes(_0x16f16b)) {
                            this.log("[" + _0x50b2fa + "][" + _0x4ab8a0 + "][" + _0x16f16b + "]" + _0x233cd0 + "");
                        } else {
                            if (_0x2977a1.includes(_0x4ab8a0)) {
                                ...
                                if (_0x3fa90f) {
                                    _0x12d224 > 3 && !_0x4a1a80.includes(_0x3fa90f) && (_0x3fa90f ? this.log("[" + _0x50b2fa + "][" + _0x3fa90f + "]") : this.log("[" + _0x50b2fa + "][" + _0x4ab8a0 + "][" + _0x16f16b + "]"));
                                    if (_0x12d224 <= 4) {
                                        break;
                                    }
                                } else {
                ...
                _0x388ae5.name == "TimeoutError" ? this.log("[" + _0x50b2fa + "]" + _0x233cd0 + "") : this.log("[" + _0x50b2fa + "](" + _0x388ae5.message + ")" + _0x233cd0 + "");
            }
        }
        const _0x561516 = {
...
class _0x520715 extends _0x49bd9d {
    ...
    async personalInfo(_0x1c3be7 = {}) {
        try {
            ...
            if (_0xeb707f?.["success"]) {
                ...
                this.log(": " + _0xeb707f.obj.availablePoints, _0x4d8f29);
            } else {
                this.log(": " + (_0xeb707f?.["errorMessage"] || (_0xeb707f ? JSON.stringify(_0xeb707f) : "")));
            }
        } catch (_0x3e58a2) {
    ...
    async queryUserInfo(_0x871831 = {}) {
        try {
            ...
            if (_0x12085d?.["success"]) {
                ...
                this.log(": " + (_0x12085d?.["errorMessage"] || (_0x12085d ? JSON.stringify(_0x12085d) : "")));
            }
        } catch (_0x415690) {
    ...
    async automaticSignFetchPackage(_0x3eb527 = {}) {
        try {
            ...
            if (_0x111089?.["success"]) {
                _0x111089?.["obj"]?.["hasFinishSign"] ? this.log("") : _0x111089?.["obj"]?.["integralTaskSignPackageVOList"]?.["length"] && this.log(": " + _0x111089?.["obj"]?.["integralTaskSignPackageVOList"]?.["map"](_0x2745fa => _0x2745fa.packetName)?.["join"](", "));
                ...
                this.log(": " + (_0x111089?.["errorMessage"] || (_0x111089 ? JSON.stringify(_0x111089) : "")));
            }
        } catch (_0x3485f6) {
                ...
                for (let _0x37eb79 of _0x55a2f0.obj.taskTitleLevels) {
                    switch (_0x37eb79.status) {
                        ...
                        case 3:
                            break;
                        default:
                            this.log("[" + _0x37eb79.title + "] -- [" + _0x37eb79.status + "]");
                            break;
                    }
                }
            } else {
                this.log(": " + (_0x55a2f0?.["errorMessage"] || (_0x55a2f0 ? JSON.stringify(_0x55a2f0) : "")));
            }
        } catch (_0x12e33e) {
    ...
    async finishTask(_0x34fd6c, _0x230f4a = {}) {
        try {
            ...
            _0x19e463?.["success"] ? this.log("[" + _0x34fd6c.title + "]") : this.log("[" + _0x34fd6c.title + "]: " + (_0x19e463?.["errorMessage"] || (_0x19e463 ? JSON.stringify(_0x19e463) : "")));
        } catch (_0x5aa88b) {
    ...
    async fetchIntegral(_0x38f19e, _0x5611d8 = {}) {
        try {
            ...
            _0x10fe8d?.["success"] ? this.log("[" + _0x38f19e.title + "]: " + _0x10fe8d.obj.point + "") : this.log("[" + _0x38f19e.title + "]: " + (_0x10fe8d?.["errorMessage"] || (_0x10fe8d ? JSON.stringify(_0x10fe8d) : "")));
        } catch (_0x329dc3) {
    ...
    async queryPointTaskAndSign(_0x4be970 = {}) {
        try {
            ...
            if (_0x82513a?.["success"]) {
                ...
                this.log(": " + (_0x82513a?.["errorMessage"] || (_0x82513a ? JSON.stringify(_0x82513a) : "")));
            }
        } catch (_0x1f2459) {
    ...
    async scanPageToRecord(_0x3292df, _0x590b36 = {}) {
        try {
            ...
            _0x92ceff?.["success"] ? this.log("[" + _0x3292df.title + "]") : this.log("[" + _0x3292df.title + "]: " + (_0x92ceff?.["errorMessage"] || (_0x92ceff ? JSON.stringify(_0x92ceff) : "")));
        } catch (_0x1f5e95) {
    ...
    async fetchPoint(_0x81f68d, _0x247dad = {}) {
        try {
            ...
            _0xe721c1?.["success"] ? this.log("[" + _0x81f68d.title + "]") : this.log("[" + _0x81f68d.title + "]: " + (_0xe721c1?.["errorMessage"] || (_0xe721c1 ? JSON.stringify(_0xe721c1) : "")));
        } catch (_0x353bb6) {
        ...
        try {
            ...
            if (_0xc58473?.["success"]) {
                ...
                for (let _0xb9006e of _0x2ba28c) {
                    ...
                    _0x4ee46b === "1" && _0x3c85c3 >= 8 && _0xd783d8.push(_0x41dd55 + ", : " + _0x11cba8);
                }
                if (_0xd783d8.length) {
                    const _0x60717f = {
                        notify: true
                ...
                this.log(": " + (_0xc58473?.["errorMessage"] || (_0xc58473 ? JSON.stringify(_0xc58473) : "")));
            }
        } catch (_0x425a1d) {
    ...
    async personalInfoNew(_0x106d38 = {}) {
        try {
            ...
            if (_0x2c3ec6?.["success"]) {
                ...
                this.log(": " + _0x2c3ec6.obj.availablePoints, _0x66941a);
            } else {
                this.log(": " + (_0x2c3ec6?.["errorMessage"] || (_0x2c3ec6 ? JSON.stringify(_0x2c3ec6) : "")));
            }
        } catch (_0xee6fd) {
        ...
        try {
            ...
            };
            {
                ...
                if (_0x5a8803?.["success"]) {
                    ...
                    friendAwards?.["length"] && this.log(": " + _0x5a8803.obj.friendAwards.map(_0x1f5f24 => _0x1f5f24.name).join(","));
                    _0x4adf12 >= _0x44b630;
                    this.log("" + gameNum + "");
                    while (gameNum-- > 0) {
                    ...
                    this.log(": " + (_0x5a8803?.["errorMessage"] || (_0x5a8803 ? JSON.stringify(_0x5a8803) : "")), _0x55e075);
                    return;
                }
            }
            {
                ...
                if (_0x3038df?.["success"]) {
                    ...
                    this.log(": " + (_0x3038df?.["errorMessage"] || (_0x3038df ? JSON.stringify(_0x3038df) : "")), _0x293e24);
                    return;
                }
            }
            {
                ...
                if (_0x487fe5?.["success"]) {
                    ...
                    this.log(": " + (_0x487fe5?.["obj"]?.["usableHoney"] || 0), _0x36358e);
                } else {
                    const _0xa7fe87 = {
                        notify: true
                    };
                    this.log(": " + (_0x487fe5?.["errorMessage"] || (_0x487fe5 ? JSON.stringify(_0x487fe5) : "")), _0xa7fe87);
                    return;
                }
            }
        } catch (_0x531ea0) {
    ...
    async bee_expand(_0x1b03ed = {}) {
        ...
        try {
            ...
            _0x44cc19?.["success"] ? (_0x3514e8 = true, this.log("")) : this.log(": " + (_0x44cc19?.["errorMessage"] || (_0x44cc19 ? JSON.stringify(_0x44cc19) : "")));
        } catch (_0xda2eeb) {
    ...
    async bee_receiveHoney(_0x40b722, _0x4e411b = {}) {
        try {
            ...
            _0x2c0e79?.["success"] ? this.log("[" + _0x40b722.type + "]: " + _0x40b722.value + "") : this.log("[" + _0x40b722.type + "]: " + (_0x2c0e79?.["errorMessage"] || (_0x2c0e79 ? JSON.stringify(_0x2c0e79) : "")));
        } catch (_0xe738a7) {
    ...
    async bee_gameReport(_0x392998 = {}) {
        try {
            ...
            if (_0x147f78?.["success"]) {
                ...
                let _0x4de714 = _0x147f78?.["errorMessage"] || (_0x147f78 ? JSON.stringify(_0x147f78) : "");
                this.log(": " + _0x4de714);
            }
        } catch (_0x4c4260) {
                ...
                for (let _0x1bb54d of _0x11eef0.obj.list) {
                    ...
                    switch (_0x1bb54d.status) {
                        ...
                        case 3:
                            break;
                        default:
                            this.log("[" + _0x1bb54d.title + "] -- [" + _0x1bb54d.status + "]");
                            break;
                    }
                }
            } else {
                this.log(": " + (_0x11eef0?.["errorMessage"] || (_0x11eef0 ? JSON.stringify(_0x11eef0) : "")));
            }
        } catch (_0x41272e) {
    ...
    async bee_finishTask(_0x1d6b15, _0x2ac632 = {}) {
        try {
            ...
            _0x56adbd?.["success"] ? this.log("[" + _0x1d6b15.taskType + "]") : this.log("[" + _0x1d6b15.taskType + "]: " + (_0x56adbd?.["errorMessage"] || (_0x56adbd ? JSON.stringify(_0x56adbd) : "")));
        } catch (_0x4f0779) {
    ...
    async superWelfare_receiveRedPacket(_0x135d8d = {}) {
        try {
            ...
            if (_0x56795b?.["success"]) {
                ...
                let _0x1a0e5f = _0x56795b?.["obj"]?.["receiveStatus"] == 1 ? "" : "";
                const _0x4ead26 = {
                    notify: true
                };
                this.log("[" + _0x1a0e5f + "]: " + _0x1ddf6c, _0x4ead26);
            } else {
                this.log(": " + (_0x56795b?.["errorMessage"] || (_0x56795b ? JSON.stringify(_0x56795b) : "")));
            }
        } catch (_0x3b26c1) {
    ...
    async memberDay_invite(_0x2ebad7 = {}) {
        try {
            ...
            if (_0x2e6b91?.["success"]) {
                ...
                let _0x3b7a40 = _0x2e6b91?.["errorMessage"] || (_0x2e6b91 ? JSON.stringify(_0x2e6b91) : "");
                this.log(": " + _0x3b7a40);
                if (_0x3b7a40?.["includes"]("")) {
    ...
    async memberDay_index(_0x2084ed = {}) {
        try {
            ...
            if (_0x3ec4ee?.["success"]) {
                ...
                let _0x56c73d = _0x3ec4ee?.["errorMessage"] || (_0x3ec4ee ? JSON.stringify(_0x3ec4ee) : "");
                this.log(": " + _0x56c73d);
                if (_0x56c73d?.["includes"]("")) {
                    this.memberDay_black = true;
                    const _0xe6c6c1 = {
                        notify: true
                    };
    ...
    async memberDay_receiveInviteAward(_0x52373a, _0x244710 = {}) {
        try {
            ...
            if (_0x48e49d?.["success"]) {
                ...
                this.log(": " + productName, _0x305509);
            } else {
                let _0x5c78f3 = _0x48e49d?.["errorMessage"] || (_0x48e49d ? JSON.stringify(_0x48e49d) : "");
                this.log(": " + _0x5c78f3);
                if (_0x5c78f3?.["includes"]("")) {
                    this.memberDay_black = true;
                    const _0x7a718e = {
                        notify: true
                    };
    ...
    async memberDay_lottery(_0x319d66 = {}) {
        try {
            ...
            if (_0x3224ef?.["success"]) {
                ...
                this.log(": " + productName, _0x4e99df);
            } else {
                let _0x182807 = _0x3224ef?.["errorMessage"] || (_0x3224ef ? JSON.stringify(_0x3224ef) : "");
                this.log(": " + _0x182807);
                if (_0x182807?.["includes"]("")) {
                    this.memberDay_black = true;
                    const _0xa33bd3 = {
                        notify: true
                    };
    ...
    async memberDay_taskList(_0x340464 = {}) {
        try {
            ...
            if (_0x55b5ca?.["success"]) {
                ...
                let _0x400b5b = _0x55b5ca?.["errorMessage"] || (_0x55b5ca ? JSON.stringify(_0x55b5ca) : "");
                this.log(": " + _0x400b5b);
                if (_0x400b5b?.["includes"]("")) {
                    this.memberDay_black = true;
                    const _0xbb5b50 = {
                        notify: true
                    };
    ...
    async memberDay_finishTask(_0x188e04, _0x59cdbe = {}) {
        try {
            ...
            if (_0x2ac6ba?.["success"]) {
                this.log("[" + _0x188e04.taskName + "]");
                await this.memberDay_fetchMixTaskReward(_0x188e04);
            } else {
                let _0x244072 = _0x2ac6ba?.["errorMessage"] || (_0x2ac6ba ? JSON.stringify(_0x2ac6ba) : "");
                this.log("[" + _0x188e04.taskName + "]: " + _0x244072);
                if (_0x244072?.["includes"]("")) {
                    this.memberDay_black = true;
                    const _0x5816e6 = {
                        notify: true
                    };
    ...
    async memberDay_fetchMixTaskReward(_0x41e80d, _0x2433ac = {}) {
        try {
            ...
            if (_0x36086f?.["success"]) {
                this.log("[" + _0x41e80d.taskName + "]");
            } else {
                let _0x231ad9 = _0x36086f?.["errorMessage"] || (_0x36086f ? JSON.stringify(_0x36086f) : "");
                this.log("[" + _0x41e80d.taskName + "]: " + _0x231ad9);
                if (_0x231ad9?.["includes"]("")) {
                    this.memberDay_black = true;
                    const _0x2339b6 = {
                        notify: true
                    };
    ...
    async memberDay_redPacketReceivedStatus(_0xfdfa8c = {}) {
        try {
            ...
            if (_0x5a308d?.["success"]) {
                ...
                let _0x58049c = _0x5a308d?.["errorMessage"] || (_0x5a308d ? JSON.stringify(_0x5a308d) : "");
                this.log(": " + _0x58049c);
                if (_0x58049c?.["includes"]("")) {
                    this.memberDay_black = true;
                    const _0x4ebf26 = {
                        notify: true
                    };
    ...
    async memberDay_receiveRedPacket(_0x2bd6e0, _0x416b42 = {}) {
        try {
            ...
            if (_0x42f2a9?.["success"]) {
                ...
                let _0x11e726 = _0x42f2a9?.["errorMessage"] || (_0x42f2a9 ? JSON.stringify(_0x42f2a9) : "");
                this.log("" + _0x2bd6e0 + ": " + _0x11e726);
                if (_0x11e726?.["includes"]("")) {
                    this.memberDay_black = true;
                    const _0x1acb7f = {
                        notify: true
                    };
        ...
        try {
            ...
            if (_0x399537?.["success"]) {
                ...
                for (let _0x3d5190 in this.memberDay_redPacket_map) {
                    ...
                    _0x565e3a.push("[" + _0x3d5190 + "]X" + this.memberDay_redPacket_map[_0x3d5190]);
                ...
                this.log(": " + _0x565e3a.join(", "), _0xfabb87);
                if (this.memberDay_redPacket_map[_0x2fc534]) {
                    const _0x1ff22a = {
                        notify: true
                    };
                    this.log("[" + _0x2fc534 + "]X" + this.memberDay_redPacket_map[_0x2fc534], _0x1ff22a);
                    ...
                    this.log("[" + _0x2fc534 + "]: [1]X" + _0x2ba9d8, _0x1b42cd);
                }
            } else {
                let _0x3470e0 = _0x399537?.["errorMessage"] || (_0x399537 ? JSON.stringify(_0x399537) : "");
                this.log(": " + _0x3470e0);
                if (_0x3470e0?.["includes"]("")) {
                    this.memberDay_black = true;
                    const _0x1d99aa = {
                        notify: true
                    };
    ...
    async memberDay_redPacketMerge(_0x10c25d, _0x2bbbf6 = {}) {
        try {
            ...
            if (_0x2d9be6?.["success"]) {
                this.log(": [" + _0x10c25d + "]X2 -> [" + (_0x10c25d + 1) + "]");
                ...
                let _0x441ffc = _0x2d9be6?.["errorMessage"] || (_0x2d9be6 ? JSON.stringify(_0x2d9be6) : "");
                this.log("[" + _0x10c25d + "]: " + _0x441ffc);
                if (_0x441ffc?.["includes"]("")) {
                    this.memberDay_black = true;
                    const _0x24ab5f = {
                        notify: true
                    };
    ...
    async memberDay_redPacketDraw(_0x4d8ea7, _0xab21dd = {}) {
        try {
            ...
            if (_0x4dbc23?.["success"]) {
                ...
                this.log("[" + _0x4d8ea7 + "]: " + (_0x2ee85c.join(", ") || ""), _0x3cd128);
            } else {
                let _0x40ddef = _0x4dbc23?.["errorMessage"] || (_0x4dbc23 ? JSON.stringify(_0x4dbc23) : "");
                this.log("[" + _0x4d8ea7 + "]: " + _0x40ddef);
                if (_0x40ddef?.["includes"]("")) {
                    this.memberDay_black = true;
                    const _0x29edc2 = {
                        notify: true
                    };
    ...
    async jika2024_taskList(_0x506887 = {}) {
        try {
            ...
            if (_0x138bfb?.["success"]) {
                ...
                this.log(": " + (_0x138bfb?.["errorMessage"] || (_0x138bfb ? JSON.stringify(_0x138bfb) : "")));
            }
        } catch (_0x5d41ef) {
    ...
    async jika2024_finishTask(_0x5a3c78, _0x2231f7 = {}) {
        try {
            ...
            _0x1c97bf?.["success"] ? (this.log("[" + _0x5a3c78.taskName + "]"), await this.jika2024_fetchMixTaskReward(_0x5a3c78)) : this.log("[" + _0x5a3c78.taskName + "]: " + (_0x1c97bf?.["errorMessage"] || (_0x1c97bf ? JSON.stringify(_0x1c97bf) : "")));
        } catch (_0x50668a) {
    ...
    async jika2024_fetchMixTaskReward(_0x1b3000, _0x1a6121 = {}) {
        try {
            ...
            if (_0x405b41?.["success"]) {
                ...
                turnedAward?.["couponName"] && _0x10ccb0.push("[]" + turnedAward?.["couponName"]);
                this.log("[" + _0x1b3000.taskName + "]: " + _0x10ccb0.join(", "));
            } else {
                let _0x22e15c = _0x405b41?.["errorMessage"] || (_0x405b41 ? JSON.stringify(_0x405b41) : "");
                this.log("[" + _0x1b3000.taskName + "]: " + _0x22e15c);
                _0x22e15c?.["includes"]("") && (this.jika_black = true);
            }
        } catch (_0x6bfaa9) {
    ...
    async jika2024_getAward(_0x42f65d, _0x14b34f = {}) {
        try {
            ...
            if (_0x299652?.["success"]) {
                ...
                turnedAward?.["couponName"] && _0x23f920.push("[]" + turnedAward?.["couponName"]);
                this.log(": " + _0x23f920.join(", "));
            } else {
                let _0x3162a2 = _0x299652?.["errorMessage"] || (_0x299652 ? JSON.stringify(_0x299652) : "");
                this.log(": " + _0x3162a2);
                _0x3162a2?.["includes"]("") && (this.jika_black = true);
            }
        } catch (_0x30059f) {
    ...
    async jika2024_chengyu_index(_0x32d187 = {}) {
        try {
            ...
            if (_0x3dd9fc?.["success"]) {
                ...
                this.log(": " + (_0x3dd9fc?.["errorMessage"] || (_0x3dd9fc ? JSON.stringify(_0x3dd9fc) : "")));
            }
        } catch (_0x33e13c) {
        ...
        try {
            ...
            if (_0x587690?.["success"]) {
                ...
                if (_0x40f4f9) {
                    ...
                    this.log("" + _0x24863b + ": " + _0x517d10.join(", "));
                } else {
                    this.log("" + _0x24863b + "");
                }
            } else {
                let _0x175854 = _0x587690?.["errorMessage"] || (_0x587690 ? JSON.stringify(_0x587690) : "");
                this.log("" + _0x24863b + ": " + _0x175854);
                _0x175854?.["includes"]("") && (this.jika_black = true);
            }
        } catch (_0x1871c1) {
        ...
        try {
            ...
            if (_0x1f0c13?.["success"]) {
                ...
                if (_0x1ab47f?.["length"]) {
                    ...
                    this.log(": " + _0x2ca6ae.join(", "), _0x23cbaa);
                ...
                this.log(": " + (_0x1f0c13?.["errorMessage"] || (_0x1f0c13 ? JSON.stringify(_0x1f0c13) : "")));
            }
        } catch (_0x32dcaf) {
    ...
    async jika2024_collectDrawAward(_0xcaa39f = {}) {
        try {
            ...
            if (_0x3e0dc5?.["success"]) {
                ...
                this.log("" + _0x1fc459.length + ": " + _0x4e0483, _0x40966a);
                for (let _0x1c10d4 of this.cards) {
                    _0x1fc459.includes(_0x1c10d4.currency) && (_0x1c10d4.balance -= 1);
                }
            } else {
                let _0x419b11 = _0x3e0dc5?.["errorMessage"] || (_0x3e0dc5 ? JSON.stringify(_0x3e0dc5) : "");
                this.log("" + _0x1fc459.length + ": " + _0x419b11);
                _0x419b11?.["includes"]("") && (this.jika_black = true);
            }
        } catch (_0x4336a2) {
    ...
    async anniversary2024_weeklyGiftStatus(_0x4f2098 = {}) {
        try {
            ...
            if (_0x5dfec6?.["success"]) {
                ...
                let _0x6547a3 = _0x5dfec6?.["errorMessage"] || (_0x5dfec6 ? JSON.stringify(_0x5dfec6) : "");
                this.log(": " + _0x6547a3);
                (_0x6547a3?.["includes"]("") || _0x6547a3?.["includes"]("")) && (this.anniversary_black = true);
            }
        } catch (_0x2c2cac) {
    ...
    async anniversary2024_receiveWeeklyGift(_0x5ba826 = {}) {
        try {
            ...
            if (_0x3084e6?.["success"]) {
                ...
                this.log(": " + _0x56e6a6.join(", "));
            } else {
                let _0x2c46a3 = _0x3084e6?.["errorMessage"] || (_0x3084e6 ? JSON.stringify(_0x3084e6) : "");
                this.log(": " + _0x2c46a3);
                (_0x2c46a3?.["includes"]("") || _0x2c46a3?.["includes"]("")) && (this.anniversary_black = true);
            }
        } catch (_0x1e4d00) {
    ...
    async anniversary2024_taskList(_0x2534c7 = {}) {
        try {
            ...
            if (_0x85486b?.["success"]) {
                ...
                this.log(": " + (_0x85486b?.["errorMessage"] || (_0x85486b ? JSON.stringify(_0x85486b) : "")));
            }
        } catch (_0x4af478) {
    ...
    async anniversary2024_finishTask(_0x4f0413, _0x39c7b0 = {}) {
        try {
            ...
            _0x5a814b?.["success"] ? (this.log("[" + _0x4f0413.taskName + "]"), await this.anniversary2024_fetchMixTaskReward(_0x4f0413)) : this.log("[" + _0x4f0413.taskName + "]: " + (_0x5a814b?.["errorMessage"] || (_0x5a814b ? JSON.stringify(_0x5a814b) : "")));
        } catch (_0x4b0690) {
    ...
    async anniversary2024_fetchMixTaskReward(_0x56d9ab, _0x1556be = {}) {
        try {
            ...
            if (_0x469902?.["success"]) {
                ...
                turnedAward?.["productName"] && _0x2d9faa.push("[]" + turnedAward?.["productName"]);
                this.log("[" + _0x56d9ab.taskName + "]: " + _0x2d9faa.join(", "));
            } else {
                let _0x2ddf1d = _0x469902?.["errorMessage"] || (_0x469902 ? JSON.stringify(_0x469902) : "");
                this.log("[" + _0x56d9ab.taskName + "]: " + _0x2ddf1d);
                _0x2ddf1d?.["includes"]("") && (this.anniversary_black = true);
            }
        } catch (_0x23d50e) {
    ...
    async anniversary2024_unbox(_0x4ad52c = {}) {
        try {
            ...
            if (_0x2fc585?.["success"]) {
                ...
                this.log(": " + (_0x465bda.join(", ") || ""));
            } else {
                let _0x26f559 = _0x2fc585?.["errorMessage"] || (_0x2fc585 ? JSON.stringify(_0x2fc585) : "");
                this.log(": " + _0x26f559);
                _0x26f559?.["includes"]("") && (this.anniversary_black = true);
            }
        } catch (_0x173e9a) {
    ...
    async anniversary2024_game_list(_0x34c0ec = {}) {
        try {
            ...
            if (_0x1c6205?.["success"]) {
                ...
                !_0x229203?.["isPassFlag"] && (this.log("PK"), await this.anniversary2024_TopicPk_topicList());
                ...
                let _0x93933c = _0x1c6205?.["errorMessage"] || (_0x1c6205 ? JSON.stringify(_0x1c6205) : "");
                this.log(": " + _0x93933c);
                _0x93933c?.["includes"]("") && (this.anniversary_black = true);
            }
        } catch (_0x1f3cf4) {
        ...
        try {
            ...
            if (_0x23b651?.["success"]) {
                ...
                if (currencyDTOList?.["length"]) {
                    ...
                    this.log("" + _0x11eafd + ": " + _0x1e5c7e.join(", "));
                } else {
                    this.log("" + _0x11eafd + "");
                }
            } else {
                let _0xbd1d34 = _0x23b651?.["errorMessage"] || (_0x23b651 ? JSON.stringify(_0x23b651) : "");
                this.log("" + _0x11eafd + ": " + _0xbd1d34);
                _0xbd1d34?.["includes"]("") && (_0x49d502 = false);
            }
        } catch (_0x4c031c) {
        ...
        try {
            ...
            if (_0x15f2a6?.["success"]) {
                ...
                if (_0x5ac8cd) {
                    ...
                    this.log("" + _0x5c3b18 + ": " + _0x37b420.join(", "));
                } else {
                    this.log("" + _0x5c3b18 + "");
                }
            } else {
                let _0x5af03a = _0x15f2a6?.["errorMessage"] || (_0x15f2a6 ? JSON.stringify(_0x15f2a6) : "");
                this.log("" + _0x5c3b18 + ": " + _0x5af03a);
                _0x5af03a?.["includes"]("") && (_0xfecded = false);
            }
        } catch (_0x33eeb6) {
    ...
    async anniversary2024_TopicPk_topicList(_0x5f3c66 = {}) {
        try {
            ...
            if (_0x43c53f?.["success"]) {
                ...
                let _0x50b886 = _0x43c53f?.["errorMessage"] || (_0x43c53f ? JSON.stringify(_0x43c53f) : "");
                this.log("PK: " + _0x50b886);
                _0x50b886?.["includes"]("") && (this.anniversary_black = true);
            }
        } catch (_0x27f54c) {
        ...
        try {
            ...
            if (_0x5f2a2a?.["success"]) {
                ...
                if (currencyDTOList.length) {
                    ...
                    this.log("PK" + _0x2b8de5 + ": " + _0x2a8eee.join(", "));
                } else {
                    this.log("PK" + _0x2b8de5 + "");
                }
            } else {
                let _0x24403d = _0x5f2a2a?.["errorMessage"] || (_0x5f2a2a ? JSON.stringify(_0x5f2a2a) : "");
                this.log("PK" + _0x2b8de5 + ": " + _0x24403d);
                _0x24403d?.["includes"]("") && (_0x38d1d7 = false);
            }
        } catch (_0x62d9d8) {
    ...
    async anniversary2024_titleList(_0x44f6bb = {}) {
        try {
            ...
            if (_0x1a5d38?.["success"]) {
                ...
                let _0x11f4f5 = _0x1a5d38?.["errorMessage"] || (_0x1a5d38 ? JSON.stringify(_0x1a5d38) : "");
                this.log(": " + _0x11f4f5);
            }
        } catch (_0x3fcd69) {
            ...
            if (_0x49edbf?.["success"]) {
                ...
                if (_0x44a979.length > 0) {
                    ...
                    if (_0x5b5c0f.answerStatus) {
                        ...
                        this.log(": " + (_0x10376f.join(", ") || ""), _0x4f63e1);
                    } else {
                        this.log("");
                    }
                } else {
                ...
                let _0x4a2fd5 = _0x49edbf?.["errorMessage"] || (_0x49edbf ? JSON.stringify(_0x49edbf) : "");
                this.log(": " + _0x4a2fd5);
            }
        } catch (_0x37edf9) {
    ...
    async anniversary2024_answer(_0x27fd08, _0x37d905, _0xfc4694 = {}) {
        try {
            ...
            if (_0x333b7d?.["success"]) {
                ...
                let _0xba557e = _0x333b7d?.["errorMessage"] || (_0x333b7d ? JSON.stringify(_0x333b7d) : "");
                this.log(": " + _0xba557e);
            }
        } catch (_0x17a545) {
        ...
        try {
            ...
            };
            {
                ...
                if (_0x15a017?.["success"]) {
                    ...
                    this.log(": " + (_0x15a017?.["errorMessage"] || (_0x15a017 ? JSON.stringify(_0x15a017) : "")));
                }
            }
            {
                let {
                ...
                if (_0x31ee71?.["success"]) {
                    ...
                    if (_0x4f1e69?.["length"]) {
                        ...
                        this.log(": " + _0x272029.join(", "), _0x10bb5c);
                    ...
                    this.log(": " + (_0x31ee71?.["errorMessage"] || (_0x31ee71 ? JSON.stringify(_0x31ee71) : "")));
                }
            }
        } catch (_0x2b5d24) {
        ...
        try {
            ...
            if (_0x1a4379?.["success"]) {
                ...
                if (_0x1e48b9?.["length"]) {
                    ...
                    this.log(": " + _0x5b666d.join(", "), _0x53fbfa);
                ...
                this.log(": " + (_0x1a4379?.["errorMessage"] || (_0x1a4379 ? JSON.stringify(_0x1a4379) : "")));
            }
        } catch (_0x169dfd) {
    ...
    async anniversary2024_collectDrawAward(_0x30fe95 = {}) {
        try {
            ...
            if (_0x5a5743?.["success"]) {
                ...
                this.log("" + _0x3eb7fe.length + ": " + _0x31f1ae, _0x33ac25);
                for (let _0x1dee5f of this.cards) {
                    _0x3eb7fe.includes(_0x1dee5f.currency) && (_0x1dee5f.balance -= 1);
                }
            } else {
                let _0x38565a = _0x5a5743?.["errorMessage"] || (_0x5a5743 ? JSON.stringify(_0x5a5743) : "");
                this.log("" + _0x3eb7fe.length + ": " + _0x38565a);
                _0x38565a?.["includes"]("") && (this.anniversary_black = true);
            }
        } catch (_0x401eec) {
    ...
    async dragonBoat2024_weeklyGiftStatus(_0x33f330 = {}) {
        try {
            ...
            if (_0x430fbc?.["success"]) {
                ...
                let _0xb90950 = _0x430fbc?.["errorMessage"] || (_0x430fbc ? JSON.stringify(_0x430fbc) : "");
                this.log(": " + _0xb90950);
                (_0xb90950?.["includes"]("") || _0xb90950?.["includes"]("")) && (this.dragonBoat_black = true);
            }
        } catch (_0xbc77c5) {
    ...
    async dragonBoat2024_receiveWeeklyGift(_0x7bf582 = {}) {
        try {
            ...
            if (_0x12ef27?.["success"]) {
                ...
                this.log(": " + _0x2d6a4d.join(", "));
            } else {
                let _0xe68b51 = _0x12ef27?.["errorMessage"] || (_0x12ef27 ? JSON.stringify(_0x12ef27) : "");
                this.log(": " + _0xe68b51);
                (_0xe68b51?.["includes"]("") || _0xe68b51?.["includes"]("")) && (this.dragonBoat_black = true);
            }
        } catch (_0x19e9e1) {
    ...
    async dragonBoat2024_taskList(_0x235da4 = {}) {
        try {
            ...
            if (_0x10d679?.["success"]) {
                ...
                this.log(": " + (_0x10d679?.["errorMessage"] || (_0x10d679 ? JSON.stringify(_0x10d679) : "")));
            }
        } catch (_0x5bb57e) {
    ...
    async dragonBoat2024_finishTask(_0x2fec7d, _0x26b7dd = {}) {
        try {
            ...
            _0x17f75a?.["success"] ? (this.log("[" + _0x2fec7d.taskName + "]"), await this.dragonBoat2024_fetchMixTaskReward(_0x2fec7d)) : this.log("[" + _0x2fec7d.taskName + "]: " + (_0x17f75a?.["errorMessage"] || (_0x17f75a ? JSON.stringify(_0x17f75a) : "")));
        } catch (_0x50edd6) {
    ...
    async dragonBoat2024_fetchMixTaskReward(_0x199ce9, _0x89a081 = {}) {
        try {
            ...
            if (_0xe9f22d?.["success"]) {
                ...
                this.log("[" + _0x199ce9.taskName + "]: " + _0x4a224b.join(", "));
            } else {
                let _0x402c01 = _0xe9f22d?.["errorMessage"] || (_0xe9f22d ? JSON.stringify(_0xe9f22d) : "");
                this.log("[" + _0x199ce9.taskName + "]: " + _0x402c01);
                _0x402c01?.["includes"]("") && (this.dragonBoat_black = true);
            }
        } catch (_0x1cf24f) {
    ...
    async dragonBoat2024_game_indexInfo(_0x4ea6e4 = {}) {
        try {
            ...
            if (_0x1cdae1?.["success"]) {
                ...
                let _0x255673 = _0x1cdae1?.["errorMessage"] || (_0x1cdae1 ? JSON.stringify(_0x1cdae1) : "");
                this.log(": " + _0x255673);
                _0x255673?.["includes"]("") && (this.dragonBoat_black = true);
            }
        } catch (_0x4872d3) {
    ...
    async dragonBoat2024_game_init(_0x4390fe, _0x437d67 = {}) {
        try {
            ...
            if (_0x5637ee?.["success"]) {
                ...
                let _0x28076f = _0x5637ee?.["errorMessage"] || (_0x5637ee ? JSON.stringify(_0x5637ee) : "");
                this.log(": " + _0x28076f);
                _0x28076f?.["includes"]("") && (this.dragonBoat_black = true);
            }
        } catch (_0x4027be) {
    ...
    async dragonBoat2024_boat_win(_0x41d2ec = 1, _0x401fcd = {}) {
        ...
        try {
            ...
            if (_0x17474d?.["success"]) {
                ...
                _0x1b6957.length ? this.log("" + _0x41d2ec + ": " + _0x1b6957.join(", ")) : this.log("" + _0x41d2ec + "");
            } else {
                let _0x43deae = _0x17474d?.["errorMessage"] || (_0x17474d ? JSON.stringify(_0x17474d) : "");
                this.log("" + _0x41d2ec + ": " + _0x43deae);
                _0x43deae?.["includes"]("") && (_0x3eed3e = false);
            }
        } catch (_0x26f38a) {
        ...
        try {
            ...
            };
            {
                ...
                if (_0x228aed?.["success"]) {
                    ...
                    this.log(": " + (_0x228aed?.["errorMessage"] || (_0x228aed ? JSON.stringify(_0x228aed) : "")));
                }
            }
            {
                let {
                ...
                if (_0x19ac46?.["success"]) {
                    ...
                    this.log(": " + this.coin + ", : " + this.rich_card, _0x35bbb2);
                    ...
                    this.log(": " + (_0x19ac46?.["errorMessage"] || (_0x19ac46 ? JSON.stringify(_0x19ac46) : "")));
                }
            }
        } catch (_0x328582) {
    ...
    async dragonBoat2024_pushCoin(_0x29d4dc = {}) {
        try {
            ...
            if (_0xf2ce07?.["success"]) {
                ...
                _0x50c982.length ? this.log(": " + _0x50c982.join(", ")) : this.log(", ");
            } else {
                this.log(": " + (_0xf2ce07?.["errorMessage"] || (_0xf2ce07 ? JSON.stringify(_0xf2ce07) : "")));
            }
        } catch (_0x418d8d) {
    ...
    async dragonBoat2024_coinStatus_checkDraw(_0x252dbf = {}) {
        try {
            ...
            if (_0x562f60?.["success"]) {
                ...
                this.log(": " + this.coin + ", : " + this.rich_card, _0x4b0a77);
                ...
                this.log(": " + (_0x562f60?.["errorMessage"] || (_0x562f60 ? JSON.stringify(_0x562f60) : "")));
            }
        } catch (_0x2f499e) {
    ...
    async dragonBoat2024_prizeDraw(_0x2d53ba, _0x53a4ec = {}) {
        ...
        try {
            ...
            if (_0x104f23?.["success"]) {
                ...
                this.log("[" + _0x2d53ba + "]: [" + giftBagName + "]" + giftBagDesc, _0x2f6b34);
            } else {
                this.log("[" + _0x2d53ba + "]: " + (_0x104f23?.["errorMessage"] || (_0x104f23 ? JSON.stringify(_0x104f23) : "")));
            }
        } catch (_0x1e405a) {
...
!(async () => {
    ...
    let _0xb2066d = _0x94f81d == "true" ? "" : "";
    _0x1366a8.log("");
    const _0x287c95 = {
        notify: true
    };
    _0x1366a8.log(": " + _0xb2066d, _0x287c95);
    _0x1366a8.log("");
    ...
    try {
        ...
        if (_0x1fc10e?.["code"] == 0) {
            ...
            if (_0x1fc10e[_0x16c88c]) {
                ...
                _0x4a47b6.status == 0 ? _0x30f72a >= _0x4a47b6.version ? (_0xfbf9a4 = true, _0x1366a8.log(_0x4a47b6.msg[_0x4a47b6.status]), _0x1366a8.log(_0x4a47b6.updateMsg), _0x1366a8.log("" + _0x30f72a + "" + _0x4a47b6.latestVersion)) : _0x1366a8.log(_0x4a47b6.versionMsg) : _0x1366a8.log(_0x4a47b6.msg[_0x4a47b6.status]);
            } else {
    ...
    return new class {
        ...
        read_env(_0x2fa345) {
            ...
            if (!this.userCount) {
                ...
                this.log("" + _0x12e0b9.map(_0x95464e => "[" + _0x95464e + "]").join(""), _0x4cdb6b);
                return false;
            }
            this.log("" + this.userCount + "");
            return true;
        }
        ...
        async exitNow() {
            ...
            this.log("[" + this.name + "]" + _0x19bd23 + "", _0x468a94);
            process.exit(0);
        }
        ...
        async wait_until(_0x53f722, _0x103248 = {}) {
            ...
            if (_0x1f66c2 > _0x478640) {
                ...
                _0x29b260.log("[" + _0x5b704a + "]" + _0x478640 / 1000 + ",", _0x2587de);
            } else {
                const _0xcd63dc = {
                    time: true
                };
                _0x29b260.log("[" + _0x5b704a + "]" + _0x1f66c2 / 1000 + ",", _0xcd63dc);
                while (_0x1f66c2 > 0) {
