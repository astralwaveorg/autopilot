 ...
 *
 * 环境变量:
 *   GQAA_COOKIE: 共青爱Cookie，多个账号用 &、\n 或 @ 分隔
 *
 * 参考文档: https://www.gqaa.com/
 */

const { Env } = require('../../utils');

const $ = new Env('共青爱签到', { sep: ['@', '\n', '&'] });
...
class Gqaa {
  ...
  async signIn() {
    try {
      const response = await $.req.get('https://www.gqaa.com/api/user/sign', {
        headers: {
          'Cookie': this.cookie,
