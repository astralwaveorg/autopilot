 ...
 *
 * 环境变量:
 *   DIDI_COOKIE: 滴滴Cookie，多个账号用 &、\n 或 @ 分隔
 *
 * 参考文档: https://www.didiglobal.com/
 */

const { Env } = require('../../utils');

const $ = new Env('滴滴签到', { sep: ['@', '\n', '&'] });
...
class Didi {
  ...
  async signIn() {
    try {
      const response = await $.req.get('https://www.didiglobal.com/api/user/sign', {
        headers: {
          'Cookie': this.cookie,
