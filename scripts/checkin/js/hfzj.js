 ...
 *
 * 环境变量:
 *   HFZJ_COOKIE: 杭州智驾Cookie，多个账号用 &、\n 或 @ 分隔
 *
 * 参考文档: https://www.hfzj.com/
 */

const { Env } = require('../../utils');

const $ = new Env('杭州智驾签到', { sep: ['@', '\n', '&'] });
...
class Hfzj {
  ...
  async signIn() {
    try {
      const response = await $.req.get('https://www.hfzj.com/api/user/sign', {
        headers: {
          'Cookie': this.cookie,
