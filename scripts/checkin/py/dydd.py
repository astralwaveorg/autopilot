...
环境变量:
   DYDD_COOKIE: 大鱼点读Cookie，多个账号用 &、\n 或 @ 分隔

参考文档: https://www.dydd.com/
"""
    ...
    def sign_in(self) -> bool:
        ...
        try:
            response = requests.get(
                'https://www.dydd.com/api/user/sign',
                headers={
                    'Cookie': self.cookie,
...
def main():
    """主函数"""
    env_value = os.getenv('DYDD_COOKIE', '')

    if not env_value:
        print('未找到环境变量 DYDD_COOKIE')
        return
