...
环境变量:
   QIDIANWU_COOKIE: 7点5Cookie，多个账号用 &、\n 或 @ 分隔

参考文档: https://www.qidianwu.com/
"""
    ...
    def sign_in(self) -> bool:
        ...
        try:
            response = requests.get(
                'https://www.qidianwu.com/api/user/sign',
                headers={
                    'Cookie': self.cookie,
...
def main():
    """主函数"""
    env_value = os.getenv('QIDIANWU_COOKIE', '')

    if not env_value:
        print('未找到环境变量 QIDIANWU_COOKIE')
        return
