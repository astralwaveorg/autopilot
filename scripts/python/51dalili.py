...
环境变量:
   DALILI_COOKIE: 51达利Cookie，多个账号用 &、\n 或 @ 分隔

参考文档: https://www.51dalili.com/
"""
    ...
    def sign_in(self) -> bool:
        ...
        try:
            response = requests.get(
                'https://www.51dalili.com/api/user/sign',
                headers={
                    'Cookie': self.cookie,
...
def main():
    """主函数"""
    env_value = os.getenv('DALILI_COOKIE', '')

    if not env_value:
        print('未找到环境变量 DALILI_COOKIE')
        return
