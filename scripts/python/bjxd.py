...
环境变量:
   BJXD_COOKIE: 北京移动Cookie，多个账号用 &、\n 或 @ 分隔

参考文档: https://www.bjxd.com/
"""
    ...
    def sign_in(self) -> bool:
        ...
        try:
            response = requests.get(
                'https://www.bjxd.com/api/user/sign',
                headers={
                    'Cookie': self.cookie,
...
def main():
    """主函数"""
    env_value = os.getenv('BJXD_COOKIE', '')

    if not env_value:
        print('未找到环境变量 BJXD_COOKIE')
        return
